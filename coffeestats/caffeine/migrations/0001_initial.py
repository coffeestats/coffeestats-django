    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cryptsum', models.CharField(
                    max_length=60, verbose_name='old password hash',
                    blank=True)),
                ('location', models.CharField(max_length=128, blank=True)),
                ('public', models.BooleanField(default=True)),
                ('token', models.CharField(unique=True, max_length=32)),
                ('timezone', models.CharField(
                    db_index=True, max_length=40, verbose_name='timezone',
                    blank=True)),
                ('groups', models.ManyToManyField(
                    ...
                    help_text='The groups this user belongs to. A user will'
                              ' get all permissions granted to each of his/her'
                              ' group.',
                    verbose_name='groups')),
                ('user_permissions',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(
                    unique=True, max_length=32, verbose_name='action code')),
                ('created', model_utils.fields.AutoCreatedField(
                    default=django.utils.timezone.now, verbose_name='created',
                    editable=False)),
                ('validuntil', models.DateTimeField(
                    verbose_name='valid until', db_index=True)),
                ('atype', models.PositiveSmallIntegerField(
                    db_index=True, verbose_name='action type',
                    choices=[(0, 'Change email')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ctype', models.PositiveSmallIntegerField(
                    db_index=True, choices=[(0, 'Coffee'), (1, 'Mate')])),
                ('date', models.DateTimeField(
                    verbose_name='consumed', db_index=True)),
                ('entrytime', model_utils.fields.AutoCreatedField(
                    default=django.utils.timezone.now, verbose_name='entered',
                    editable=False, db_index=True)),
                ('timezone',
                 models.CharField(db_index=True, max_length=40, blank=True)),
                ('user', models.ForeignKey(
                    to=settings.AUTH_USER_MODEL, on_delete=models.PROTECT)),
            ],
            options={
